...
public class NeighbourhoodSearch {
    ...
    private NeighbourhoodSearch(int match, int insert, int delete, int replace, int neighbour) {
        this.match = match;
        this.insert = insert;
        this.delete = delete;
    ...
    private String getDictWord(NeighbourhoodSearch distance, String mistakeWord, ArrayList<String> listDict) {
    ...
    private ArrayList<String> getDictWords(NeighbourhoodSearch distance, String mistakeWord, ArrayList<String> listDict) {
        ...
        for(String result: dicMap.keySet()){
            if(dicMap.get(result).equals(neighbour)) {
    ...
    public static void main(String args[]) throws FileNotFoundException {
        NeighbourhoodSearch distance = new NeighbourhoodSearch(0, 1, 1, 1, 2);
